            ...
            <div class="column">
              <div class="content-section">
                ...
                <p class="white-text">
                  ...
                  <a href="https://github.com/CaliDog/certstream-python">Python</a>,
                  <a href="https://github.com/CaliDog/certstream-js">Javascript</a>,
                ...
                <div class="typer-wrapper">
                  <p
                    :class="{
                      active: activeLanguage !== null && activeLanguage !== 'java'
                    }"
              ...
              <div class="content-section cli-example">
                ...
                <p class="white-text">
                  ...
                  and run it like any other program. It can be used to emit certificate data in a
                  number of forms to be processed by other command line utilities (or just for
                  storage). Pipe it into grep, sed, awk, jq, or any other utility to send alerts,
...
.top-panel {
  ...
  background: url("https://storage.googleapis.com/certstream-artifacts/certstream-bg.png") no-repeat
    center center fixed;
